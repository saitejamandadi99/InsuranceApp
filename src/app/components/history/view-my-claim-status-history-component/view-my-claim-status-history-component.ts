...
export class ViewMyClaimStatusHistoryComponent implements OnInit {
  ...
  constructor(private historyService: ClaimStatusServices,private cdr: ChangeDetectorRef,private toastServies:ToastServices) {}
  ...
  loadMyHistory() {
    ...
    this.historyService.getMyClaimStatusHistory().subscribe({
      ...
      error: (err: HttpErrorResponse) => {
        ...
        this.toastServies.error(apiError.Message);
      }
    });
